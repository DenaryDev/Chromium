...
public abstract class MixinTitleScreenOld extends Screen {
    ...
    public void init() {
        ...
        this.addDrawableChild(new ButtonWidget(x,centerY + 32, buttonW, 20, new TranslatableText("sapphireclient.menu.vkGroup"), (element) -> {
            this.confirmOpened = false;
       ...
       // this.addDrawableChild(appearance);
        ...
        this.addDrawableChild(new ButtonWidget(this.width - 22, 15, 20, 20, new TranslatableText("R"), (element) ->
                this.client.setScreen(this)));
